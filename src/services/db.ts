...
export const initializeDB = async (forceReset = false) => {
  try {
    ...
    if (!initialized || !hasG1001 || !hasEmp103 || forceReset) {
      ...
      // Seed today's 5 patrols for G-1001 / guard-1 starting from 02:00 PM
      const patrolsList: DBPatrol[] = [
        {
          id: 'patrol-today-1400',
        ...
        {
          id: 'patrol-today-1800',
          patrolCode: `PT-${todayStr.replace(/-/g, '')}-03`,
        ...
        {
          id: 'patrol-today-2000',
          patrolCode: `PT-${todayStr.replace(/-/g, '')}-04`,
        ...
        {
          id: 'patrol-today-2200',
          patrolCode: `PT-${todayStr.replace(/-/g, '')}-05`,
...
const DEFAULT_ASSETS: DBAsset[] = [
  {
    ...
    assignedBy: 'Jane Smith (Supervisor)',
    condition: 'Excellent',
    quantity: 1,
    status: 'Assigned',
  ...
  },
  {
    id: 'ast-104',
    assetCode: 'AST-1004',
    name: 'Hytera Body Worn Camera VR-20',
    type: 'Electronics',
    serialNumber: 'SN-HYT-30219',
    site: 'Ahmedabad Plant (Ranucle Zundal)',
    siteId: 'site-001',
    assignedTo: 'John Smith',
    assignedGuardId: 'G-1001',
    assignedGuardEmail: 'john@priority-one.io',
    assignedDate: 'Aug 10, 2026',
    condition: 'Excellent',
    quantity: 1,
    status: 'Assigned',
    companyId: 'company-001',
    notes: 'Full HD body camera unit with infrared night vision.',
  },
  {
    id: 'ast-105',
    assetCode: 'AST-1005',
    name: 'Heavy Duty Tactical Patrol Baton',
    type: 'Security Gear',
    serialNumber: 'SN-BAT-55421',
    site: 'Ahmedabad Plant (Ranucle Zundal)',
    siteId: 'site-001',
    assignedTo: 'John Smith',
    assignedGuardId: 'G-1001',
    ...
    status: 'Assigned',
    companyId: 'company-001',
    notes: 'Expandable steel security patrol baton.',
  },
  {
    id: 'ast-106',
    assetCode: 'AST-1006',
    name: 'Pro-Duty Noise Cancelling Radio Headset',
    type: 'Communication',
    serialNumber: 'SN-HD-77218',
    site: 'Ahmedabad Plant (Ranucle Zundal)',
    siteId: 'site-001',
    assignedTo: 'John Smith',
    assignedGuardId: 'G-1001',
    ...
    status: 'Assigned',
    companyId: 'company-001',
    notes: 'Noise-cancelling tactical headset with push-to-talk button.',
  },
];
