  ...
  return (
    <Card variant="elevated" style={styles.card}>
      <View style={styles.header}>
        <Heading level="h4">Today's Shift</Heading>
        <View style={[styles.statusBadge, { backgroundColor: colors.primary[50], borderRadius: borderRadius.full }]}>
          <AppText size="xs" color={colors.primary[600]} weight="medium">Upcoming</AppText>
        </View>
      </View>
